...
<form method="POST" enctype="multipart/form-data">
	...
	<p><label id="persetujuan_asrama">persetujuan_asrama : </label><input type="checkbox" name="persetujuan_asrama" value="1" value="1"
    <?= (!empty($persetujuan_asrama)) ? 'checked' : '' ?>><div class="error-val"></div></p>
	<p><label id="persetujuan_tidak_membawa_hp">persetujuan_tidak_membawa_hp : </label><input type="checkbox" name="persetujuan_tidak_membawa_hp" value="1"
    <?= (!empty($persetujuan_tidak_membawa_hp)) ? 'checked' : '' ?>><div class="error-val"></div></p>
